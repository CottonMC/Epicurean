...
public class EpicureanItems {
	...
	//ingredients
	public static final Item TOMATO = register("tomato", new SeasoningItem(2, 0.3f, StatusEffects.HASTE, DEFAULT_SETTINGS.food(new FoodItemSetting.Builder().hunger(2).saturationModifier(0.2F).build())));
	public static final Item PEPPER = register("pepper", new SeasoningItem(2, 0.3f, StatusEffects.RESISTANCE, DEFAULT_SETTINGS.food(new FoodItemSetting.Builder().hunger(2).saturationModifier(0.2F).build())));
	...
	public static final Item SOY_SAUCE = register("soy_sauce", new SeasoningItem(1, 0.1f, StatusEffects.STRENGTH, DEFAULT_SETTINGS));
