...
public class EpicureanItems {
	...
	//ingredients
	public static final Item TOMATO = register("tomato", new FoodCropItem(2, 0.2f, EpicureanCrops.TOMATO_PLANT, SoundEvents.ITEM_CROP_PLANT, DEFAULT_SETTINGS));
	public static final Item PEPPER = register("pepper", new FoodCropItem(2, 0.2f, EpicureanCrops.PEPPER_PLANT, SoundEvents.ITEM_CROP_PLANT, DEFAULT_SETTINGS));
